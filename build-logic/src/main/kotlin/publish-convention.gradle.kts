...
// ── Javadoc JAR from Dokka (required by Central) ────────────────────────────────
val javadocJar by tasks.registering(Jar::class) {
    archiveClassifier.set("javadoc")
    // Include Dokka output (generated by root project)
    dependsOn(tasks.named("dokkaHtml", org.jetbrains.dokka.gradle.DokkaTask::class))
