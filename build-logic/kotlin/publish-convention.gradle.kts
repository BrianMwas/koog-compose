...
publishing {
    publications.withType<MavenPublication>().configureEach {
        ...
        pom {
            ...
            url.set("https://github.com/YOUR_GITHUB_USERNAME/koog-compose")
            ...
            developers {
                developer {
                    id.set("YOUR_GITHUB_USERNAME")
                    name.set("Brian")
                    url.set("https://github.com/YOUR_GITHUB_USERNAME")
                }
            }

            scm {
                url.set("https://github.com/YOUR_GITHUB_USERNAME/koog-compose")
                connection.set("scm:git:git://github.com/YOUR_GITHUB_USERNAME/koog-compose.git")
                developerConnection.set("scm:git:ssh://git@github.com/YOUR_GITHUB_USERNAME/koog-compose.git")
            }

            issueManagement {
                system.set("GitHub Issues")
                url.set("https://github.com/YOUR_GITHUB_USERNAME/koog-compose/issues")
            }
        }
    }
